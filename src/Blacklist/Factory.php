...
class Factory extends AbstractApi implements FactoryInterface
{
    ...
    {
        return AbstractApi::request($this->apiKey, 'blacklist/add/', $this->post);
    }
    ...
    {
        return AbstractApi::request($this->apiKey, 'blacklist/edit/', $this->post);
    }
    ...
    {
        return AbstractApi::request($this->apiKey, 'blacklist/delete/', $this->post);
    }
